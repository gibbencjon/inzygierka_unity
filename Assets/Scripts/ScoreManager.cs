...
public class ScoreManager : MonoBehaviour
{
    ...
    {   // wynik dzielenia obecnych trafionych kafelkow przez wszystkie przeleciane kafelki
        final_score = Mathf.Round((tiles_hit_perfect + (tiles_hit_early * 0.5f) + (tiles_hit_late * 0.5f)) 
        / (tiles_missed + tiles_hit_early + tiles_hit_perfect + tiles_hit_late) * 100).ToString();
